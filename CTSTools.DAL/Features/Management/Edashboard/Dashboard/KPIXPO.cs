...
[Persistent(@"KPI")]
public class KPIXPO : XPObject
{

    public KPIXPO(Session session) : base(session)
    {
    }
    ...
    KPIXPO fParenKPI;
    public KPIXPO ParenKPI
    {
        get { return fParenKPI; }
        set { SetPropertyValue(nameof(ParenKPI), ref fParenKPI, value); }
    }
