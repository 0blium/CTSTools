...
[Persistent(@"DashboardMetric")]
public class DashboardMetricXPO : XPObject
{

    public DashboardMetricXPO(Session session) : base(session)
    {
    }
    ...
    {
        get { return fMetric; }
        set { SetPropertyValue<MetricXPO>(nameof(Metric), ref fMetric, value); }
    }
