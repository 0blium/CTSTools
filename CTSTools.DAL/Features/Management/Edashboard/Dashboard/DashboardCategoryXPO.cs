...
[Persistent(@"DashboardCategory")]
public class DashboardCategoryXPO : XPObject
{

    public DashboardCategoryXPO(Session session) : base(session)
    {
    }
    ...
    {
        get { return fPanelName; }
        set { SetPropertyValue<string>(nameof(PanelName), ref fPanelName, value); }
    }
    DateTime? fAddedDate;
