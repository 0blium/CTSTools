...
namespace CTSTools.DAL.Features.Management.Edashboard.Settings;
[Persistent(@"CalculationType")]
public class CalculationTypeXPO : XPObject
{

    public CalculationTypeXPO(Session session) : base(session)
    {
    }
