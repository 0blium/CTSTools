...
namespace CTSTools.DAL.Features.Engineering.ComponentID.Class
{
    [Persistent(@"Class")]
    public class ClassXPO : XPObject
    {
        public ClassXPO(Session session) : base(session)
        {
        ...
        ValueLinkXPO fValueLink;
        public ValueLinkXPO ValueLink
        {
            get { return fValueLink; }
            set { SetPropertyValue<ValueLinkXPO>(nameof(ValueLink), ref fValueLink, value); }
        }
        PartTypeXPO fPartType;
        public PartTypeXPO PartType
        {
            get { return fPartType; }
            set { SetPropertyValue<PartTypeXPO>(nameof(PartType), ref fPartType, value); }
        }
        ComponentTypeXPO fComponentType;
        public ComponentTypeXPO ComponentType
        {
            get { return fComponentType; }
            set { SetPropertyValue<ComponentTypeXPO>(nameof(ComponentType), ref fComponentType, value); }
        }
