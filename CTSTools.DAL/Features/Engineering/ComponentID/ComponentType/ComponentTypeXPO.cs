...
namespace CTSTools.DAL.Features.Engineering.ComponentID.ComponentType
{
    [Persistent(@"ComponentType")]
    public class ComponentTypeXPO : XPObject
    {
        public ComponentTypeXPO(Session session) : base(session)
        {
