...
namespace CTSTools.DAL.Features.AdvancedSettings.MailGroupManagement;

[Persistent(@"MailGroupMember")]
public class MailGroupMemberXPO : XPObject
{
    public MailGroupMemberXPO() : base()
    {
        // This constructor is used when an object is loaded from a persistent storage.
        // Do not place any code here.
    }

    public MailGroupMemberXPO(Session session) : base(session)
    {
        // This constructor is used when an object is loaded from a persistent storage.
        // Do not place any code here.
    }
    ...
    MailGroupXPO fMailGroup;
    public MailGroupXPO MailGroup
    {
        get { return fMailGroup; }
        set { SetPropertyValue<MailGroupXPO>(nameof(MailGroup), ref fMailGroup, value); }
    }
    UserXPO fUser;
    public UserXPO User
    {
