...
public class SparePart_LotMap
{
    public static SparePart_LotDTO XPOToDTO(SparePart_LotXPO SparePart_LotXPO)
    {
        ...
        try
        {
            ...
            _sparepart_lotDTO.ProviderID = (SparePart_LotXPO.Provider != null) ? SparePart_LotXPO.Provider.Oid : 0;
            _sparepart_lotDTO.ProviderName = (SparePart_LotXPO.Provider != null) ? SparePart_LotXPO.Provider.Name : "Unnassigned";
            _sparepart_lotDTO.SparePartID = (SparePart_LotXPO.SparePart != null) ? SparePart_LotXPO.SparePart.Oid : 0;
            _sparepart_lotDTO.SparePartName = (SparePart_LotXPO.SparePart != null) ? SparePart_LotXPO.SparePart.Name : "Unnassigned";
            ...
            _sparepart_lotDTO.SparePartInventoryID = (SparePart_LotXPO.SparePartInventory != null) ? SparePart_LotXPO.SparePartInventory.Oid : 0;
            _sparepart_lotDTO.SupportGroupID = (SparePart_LotXPO.SupportGroup != null) ? SparePart_LotXPO.SupportGroup.Oid : 0;
            _sparepart_lotDTO.SupportGroupName = (SparePart_LotXPO.SupportGroup != null) ? SparePart_LotXPO.SupportGroup.Name : "Unnassigned";
            _sparepart_lotDTO.TransactionOriginID = (SparePart_LotXPO.TransactionOrigin != null) ? SparePart_LotXPO.TransactionOrigin.Oid : 0;
            _sparepart_lotDTO.TransactionOriginName = (SparePart_LotXPO.TransactionOrigin != null) ? SparePart_LotXPO.TransactionOrigin.Name : "Unnassigned";
    ...
    public static SparePart_LotXPO DTOtoXPO(SparePart_LotDTO SparePart_LotDTO, UnitOfWork UnitOfWork)
    {
        ...
        try
        {
            ...
            _sparepart_lotXPO.Provider = (_sparepart_lotXPO.Provider?.Oid == SparePart_LotDTO.ProviderID) ? _sparepart_lotXPO.Provider : UnitOfWork.GetObjectByKey<ProviderXPO>(SparePart_LotDTO.ProviderID);
            _sparepart_lotXPO.SparePart = (_sparepart_lotXPO.SparePart?.Oid == SparePart_LotDTO.SparePartID) ? _sparepart_lotXPO.SparePart : UnitOfWork.GetObjectByKey<SparePartXPO>(SparePart_LotDTO.SparePartID);
            _sparepart_lotXPO.SparePartInventory = (_sparepart_lotXPO.SparePartInventory?.Oid == SparePart_LotDTO.SparePartInventoryID) ? _sparepart_lotXPO.SparePartInventory : UnitOfWork.GetObjectByKey<SparePartInventoryXPO>(SparePart_LotDTO.SparePartInventoryID);
            _sparepart_lotXPO.SupportGroup = (_sparepart_lotXPO.SupportGroup?.Oid == SparePart_LotDTO.SupportGroupID) ? _sparepart_lotXPO.SupportGroup : UnitOfWork.GetObjectByKey<SupportGroupXPO>(SparePart_LotDTO.SupportGroupID);
            _sparepart_lotXPO.TransactionOrigin = (_sparepart_lotXPO.TransactionOrigin?.Oid == SparePart_LotDTO.TransactionOriginID) ? _sparepart_lotXPO.TransactionOrigin : UnitOfWork.GetObjectByKey<TransactionOriginXPO>(SparePart_LotDTO.TransactionOriginID);
