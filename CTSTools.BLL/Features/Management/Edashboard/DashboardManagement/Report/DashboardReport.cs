...
namespace CTSTools.BLL.Features.Management.Edashboard.DashboardManagement.Report
{
    public partial class DashboardReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private XRTable CreateTableRowWithRowSpan(XRTable Table, int RowSpan, DashboardReportDTO DashboardReportInformation, Dashboard_KPIDTO MainData)
        {
            ...
            new XRTableCell() { Text = DashboardReportInformation.MetricName+Environment.NewLine+_measurenmentLengends, WidthF = 380f,Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular), BackColor = ColorTranslator.FromHtml(DashboardReportInformation.MetricBackgroundColor), WordWrap=true,Multiline=true},
            ...
            new XRTableCell() { Text = (DashboardReportInformation.AprilIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.AprilValue  != null) ? DashboardReportInformation.AprilValue.ToString() + " %" : DashboardReportInformation.AprilValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.AprilBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.MayIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.MayValue  != null) ? DashboardReportInformation.MayValue.ToString() + " %" : DashboardReportInformation.MayValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.MayBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.JuneIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.JuneValue != null) ? DashboardReportInformation.JuneValue.ToString() + " %" : DashboardReportInformation.JuneValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.JuneBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.JulyIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.JulyValue != null) ? DashboardReportInformation.JulyValue.ToString() + " %" : DashboardReportInformation.JulyValue.ToString(), WidthF = 50f , Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.JulyBackgroundColor)},
            ...
            new XRTableCell() { Text = (DashboardReportInformation.SepIgnoreMetric == true) ? "N/A" :(DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.SepValue != null) ? DashboardReportInformation.SepValue.ToString() + " %" : DashboardReportInformation.SepValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.SepBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.OctuberIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.OctuberValue != null) ? DashboardReportInformation.OctuberValue.ToString() + " %" : DashboardReportInformation.OctuberValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular), BackColor = ColorTranslator.FromHtml(DashboardReportInformation.OctuberBackgroundColor), },
            new XRTableCell() { Text = (DashboardReportInformation.NovemberIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.NovemberValue  != null) ? DashboardReportInformation.NovemberValue.ToString() + " %" : DashboardReportInformation.NovemberValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular), BackColor = ColorTranslator.FromHtml(DashboardReportInformation.NovemberBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.DecemberIgnoreMetric == true) ? "N/A" :(DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.DecemberValue  != null) ? DashboardReportInformation.DecemberValue.ToString() + " %" : DashboardReportInformation.DecemberValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.DecemberBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.JanuaryIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.JanuaryValue  != null) ? DashboardReportInformation.JanuaryValue.ToString() + " %" : DashboardReportInformation.JanuaryValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.JanuaryBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.FebruaryIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.FebruaryValue  != null) ? DashboardReportInformation.FebruaryValue.ToString() + " %" : DashboardReportInformation.FebruaryValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.FebruaryBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.MarchIgnoreMetric == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.MarchValue  != null) ? DashboardReportInformation.MarchValue.ToString() + " %" : DashboardReportInformation.MarchValue.ToString(),WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.MarchBackgroundColor) },
