    ...
    public partial class DashboardReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Detail_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            if (_reportDataSourceList.Count > 0)
            {
                ...
                ProcessDashboardInformation(_reportDataSourceList.Where(x => x.DashboardCategoryID == (int)DashboardCategory_Enum.Environmental).OrderBy(x => x.Order).ToList(), _table, _mainDatasource[0]);
        ...
        private void CreateTableTotalRow(XRTable Table, List<DashboardReportDTO> ReportList)
        {
            ...
            new XRTableCell() { Text = _monthlyTotalValues.OctuberTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.NovemberTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.DecemberTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.JanuaryTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.FebruaryTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.MarchTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.AprilTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.MayTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.JuneTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.JulyTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.AugustTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text = _monthlyTotalValues.SeptemberTotal, WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
            new XRTableCell() { Text =   String.Format("{0:0.00}%", (_counter == 0 ? 0 : _total / _counter)),  WidthF = 70f , Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular) },
        ...
        {
            //Get total KPI count
            int _totalKPICount = ReportList.Where(_where => _where.IgnoreKPI == false).Count();
            //Get count of red KPI 
        ...
        private XRTable CreateTable(int FiscalYear)
        {
            ...
            _rowHeader.Font = new System.Drawing.Font("Arial", 6, System.Drawing.FontStyle.Bold);
        ...
        private void ProcessDashboardInformation(List<DashboardReportDTO> DashboardInformationList, XRTable Table, Dashboard_KPIDTO MainDataSource)
        {
            ...
            foreach (DashboardReportDTO _elementInList in DashboardInformationList)
            {
                ...
                //Environment
                else if (_elementInList.DashboardCategoryID == (int)DashboardCategory_Enum.Environmental)
                {
                    if (_environmentCount == 0)
                    {
                        Table = CreateTableRowWithRowSpan(Table, DashboardInformationList.Where(_where => _where.DashboardCategoryID == (int)DashboardCategory_Enum.Environmental).Count(), _elementInList, MainDataSource);
                        _environmentCount++;
                    }
                    else { Table = CreateTableRow(Table, _elementInList, MainDataSource); }
                }
        ...
        private XRTable CreateTableRowWithRowSpan(XRTable Table, int RowSpan, DashboardReportDTO DashboardReportInformation, Dashboard_KPIDTO MainData)
        {
            ...
            string _fiscalYeatBackgroundColor = String.Format("{0}", Dashboard_KPI_Service.SetKPIColumnBackground(DashboardReportInformation.EquivalenceID, _fiscalYearTotal, Convert.ToDecimal(DashboardReportInformation.Goal), DashboardReportInformation.GoalRange));
            ...
            new XRTableCell() { Text = DashboardReportInformation.KPIName+Environment.NewLine+_measurenmentLengends, WidthF = 380f,Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular), BackColor = ColorTranslator.FromHtml(DashboardReportInformation.KPIBackgroundColor), WordWrap=true,Multiline=true},
            ...
            new XRTableCell() { Text = (DashboardReportInformation.AprilIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.AprilValue  != null) ? DashboardReportInformation.AprilValue.ToString() + " %" : DashboardReportInformation.AprilValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.AprilBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.MayIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.MayValue  != null) ? DashboardReportInformation.MayValue.ToString() + " %" : DashboardReportInformation.MayValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.MayBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.JuneIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.JuneValue != null) ? DashboardReportInformation.JuneValue.ToString() + " %" : DashboardReportInformation.JuneValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.JuneBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.JulyIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.JulyValue != null) ? DashboardReportInformation.JulyValue.ToString() + " %" : DashboardReportInformation.JulyValue.ToString(), WidthF = 50f , Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.JulyBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.AugustIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.AugustValue != null) ? DashboardReportInformation.AugustValue.ToString() + " %" : DashboardReportInformation.AugustValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.AugustBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.SepIgnoreKPI == true) ? "N/A" :(DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.SepValue != null) ? DashboardReportInformation.SepValue.ToString() + " %" : DashboardReportInformation.SepValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.SepBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.OctuberIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent && DashboardReportInformation.OctuberValue != null) ? DashboardReportInformation.OctuberValue.ToString() + " %" : DashboardReportInformation.OctuberValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular), BackColor = ColorTranslator.FromHtml(DashboardReportInformation.OctuberBackgroundColor), },
            new XRTableCell() { Text = (DashboardReportInformation.NovemberIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.NovemberValue  != null) ? DashboardReportInformation.NovemberValue.ToString() + " %" : DashboardReportInformation.NovemberValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular), BackColor = ColorTranslator.FromHtml(DashboardReportInformation.NovemberBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.DecemberIgnoreKPI == true) ? "N/A" :(DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.DecemberValue  != null) ? DashboardReportInformation.DecemberValue.ToString() + " %" : DashboardReportInformation.DecemberValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.DecemberBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.JanuaryIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.JanuaryValue  != null) ? DashboardReportInformation.JanuaryValue.ToString() + " %" : DashboardReportInformation.JanuaryValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.JanuaryBackgroundColor) },
            new XRTableCell() { Text = (DashboardReportInformation.FebruaryIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.FebruaryValue  != null) ? DashboardReportInformation.FebruaryValue.ToString() + " %" : DashboardReportInformation.FebruaryValue.ToString(), WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.FebruaryBackgroundColor)},
            new XRTableCell() { Text = (DashboardReportInformation.MarchIgnoreKPI == true) ? "N/A" : (DashboardReportInformation.ValueType == (int)ValueType_Enum.Percent  && DashboardReportInformation.MarchValue  != null) ? DashboardReportInformation.MarchValue.ToString() + " %" : DashboardReportInformation.MarchValue.ToString(),WidthF = 50f, Font = new System.Drawing.Font("Arial", 5, System.Drawing.FontStyle.Regular),BackColor = ColorTranslator.FromHtml(DashboardReportInformation.MarchBackgroundColor) },
