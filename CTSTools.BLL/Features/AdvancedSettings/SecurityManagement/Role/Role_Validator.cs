...
public class Role_Validator
{
    public static ValidationResultDTO CreateRole_Validation(RoleDTO RoleDTO)
    {
        ...
        try
        {
            ...
            if (string.IsNullOrEmpty(RoleDTO.Name) )
            {
                _validation_ResultList.Add(new ValidationResultDTO
                {
                    ...
                    Data = $"{nameof(Role)}{nameof(RoleDTO.Name)}", 
                });
            }
    ...
    public static ValidationResultDTO UpdateRole_Validation(RoleDTO RoleDTO)
    {
        var _validation_ResultDTO = new ValidationResultDTO
        {
            Description = "The record has been validated successfully.."
    ...
    public static ValidationResultDTO DeleteRole_Validation(RoleDTO RoleDTO)
    {
        var _validation_ResultDTO = new ValidationResultDTO
        {
            Description = "The record has been validated successfully.."
