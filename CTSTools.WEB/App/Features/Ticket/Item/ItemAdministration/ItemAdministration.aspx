<%@ Page Title="" Language="C#" MasterPageFile="~/App/Features/MasterPage/CTSTools.Master" AutoEventWireup="true" CodeBehind="ItemAdministration.aspx.cs" Inherits="CTSTools.WEB.App.Features.Ticket.Item.ItemAdministration.ItemAdministration" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-xl-start">
                ...
                <li class="breadcrumb-item active">Item Administration</li>
            </ol>
        </div>
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <div class="row">
            <h1 class="page-header">Item Administration</h1>
        </div>
    </div>
    <!-- END page-header -->
    <div class="row">
        <div class="col-md-12">
            <a id="AddNewItemHeaderBtn" class="btn btn-success mb-1" data-bs-toggle="modal" data-bs-target="#AddNewItemHeaderModal">Add new item</a>
            <div class="panel panel-inverse">
                <div class="panel-heading p-1">
                    <h4 class="panel-title"></h4>
                    <div class="panel-heading-btn">
                        <a class="btn btn-sm btn-success" data-bs-target="#AddUserDefinedFieldsModal" data-bs-toggle="modal">Add Fields</a>
                        <a id="AssignUserDefinedBtn" class="btn btn-sm btn-success d-none" data-bs-target="#AssignUserDefinedFieldsModal" data-bs-toggle="modal">Assign Fields</a>
...
<script type="module" src="/App/Features/Ticket/Item/ItemAdministration/ItemAdministration.js?v=2"></script>
</asp:Content>
