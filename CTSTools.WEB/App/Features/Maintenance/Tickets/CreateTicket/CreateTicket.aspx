<%@ Page Title="" Language="C#" MasterPageFile="~/App/Features/MasterPage/CTSTools.Master" AutoEventWireup="true" CodeBehind="CreateTicket.aspx.cs" Inherits="CTSTools.WEB.App.Features.Maintenance.Tickets.CreateTicket.CreateTicket" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="module" src="/App/Features/Maintenance/Tickets/CreateTicket/CreateTicket.js?v=1"></script>
</asp:Content>
