...
import { GetItem_LineInformation, GetItem_LineInformationBySupportGroup } from '../../AMS/ItemManagement/Item_Line/Item_Line_Service.js'
...
function BuildSuccessMessage(ValidationResult) {
    ...
    $("#success-message").append('<div>' +
        ...
        /* '<p><u>:</u></p>' +*/
        '<a class="btn btn-default mt-3 mr-3" href="/App/Features/Default.aspx">Home</a> <a class="btn btn-success mt-3 mr-3" href="/App/Features/Maintenance/Tickets/CreateTicket/CreateTicket.aspx">Submit Another ticket</a>' +
        '</div>' +
        '</div>' +
        '</div>');
}