...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-body">
                    <div class="col-md-12 ">
                        <a id="NewProviderBtn" href="#SaveProviderRecordModal" class="btn btn-success mb-2" data-bs-toggle="modal"><i class="fa-solid fa-circle-plus"></i> Provider</a>
                    </div>
    ...
    <!-- Modal save record -->
    <div class="modal fade" id="SaveProviderRecordModal" tabindex="-1" data-bs-backdrop="static" aria-modal="true" role="dialog">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="ProviderModalTitle" class="modal-title fs-5"></h4>
                    <button type="button" id="btnCloseProviderModal" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div>
