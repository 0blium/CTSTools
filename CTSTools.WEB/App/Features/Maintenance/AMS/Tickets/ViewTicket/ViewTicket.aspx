<%@ Page Title="" Language="C#" MasterPageFile="~/App/Features/MasterPage/CTSTools.Master" AutoEventWireup="true" CodeBehind="ViewTicket.aspx.cs" Inherits="CTSTools.WEB.App.Features.Ticket.Tickets.ViewTicket.ViewTicket" %>
...
<div id="TicketContent">
    ...
    <div class="tab-content panel borderCustom rounded-0 p-3 m-0">
        ...
        <div class="tab-pane fade active show" id="DataEntry-tab" role="tabpanel">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="textColor">General Information</h4>
                </div>
...
<script type="module" src="/App/Features/Ticket/Tickets/ViewTicket/ViewTicket.js"></script>
</asp:Content>
