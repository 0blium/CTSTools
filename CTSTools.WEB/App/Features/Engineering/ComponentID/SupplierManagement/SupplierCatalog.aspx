...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            <div class="panel-body">
                ...
                <a class="btn btn-success mb-2 float-end" id="UploadExcelModalButton" data-bs-toggle="modal" data-bs-target="#UploadExcelModal"><i class="fa-solid fa-file-import"></i>Excel</a>
    ...
    <div class="modal fade" id="UploadExcelModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Upload file excel</h1>
                    <button type="button" id="UploadExcelCloseModalButton" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-15px center">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary float-end" id="ClearUpdateExcelButton" type="button">Clear</button>
                </div>
            </div>
        </div>
    </div>
